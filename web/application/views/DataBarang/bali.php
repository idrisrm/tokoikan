            ...
            <main>
                ...
                <div class="container mt-4">
                    <nav class="nav nav-borders">
                        <a class="nav-link " href="<?= base_url('DataBarang/jember') ?>">Data Barang Wilayah Jember</a>
                        <a class="nav-link " href="<?= base_url('DataBarang/situbondo') ?>">Data Barang Wilayah Situbondo</a>
                        <a class="nav-link active" href="<?= base_url('DataBarang/bali') ?>">Data Barang Wilayah Bali</a>
                    </nav>

                    <hr class="mt-0 mb-4" /><div class="container mt-4">
                        <div class="col-12 col-xl-auto">
                            <div class="card bg-white text-black">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="mr-3">
                                            <div class="text-black-75 small">Nominal barang</div>
                                            <div class="text-lg font-weight-bold">Rp. <?= number_format($nominal['total'], 0, ",", ".") ?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
