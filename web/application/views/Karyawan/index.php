                ...
                <div class="page-header page-header-dark bg-gradient-primary-to-secondary pb-10">
                    <div class="container-fluid">
                        <div class="page-header-content">
                            ...
                            <div class="page-header-subtitle">Master Data Karyawan</div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="datatable table-responsive">
                                ...
                                <thead>
                                    ...
                                    <tbody>
                                        <?php $i=1; foreach($karyawan as $data){?>
                                            <tr>
                                                <td><?= $i;?></td>
                                                <td><?= $data['nama']?></td>
                                                <td><?= $data['wilayah']?></td>
                                                <td><?= $data['status']?></td>
                                                <td>
                                                    <a class="btn btn-datatable btn-icon btn-transparent-dark" href="<?= base_url('Karyawan/edit/' . $data['id'])?>" >
