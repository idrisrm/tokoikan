            ...
            <main>
                    ...
                    <div class="container-fluid">
                        <div class="page-header-content">
                            <h1 class="page-header-title">
                                ...
                                <span>Edit Data Kustomer Kredit</span>
                            </h1>
                        </div>
                    </div>
                </div>
                <div class="container-fluid mt-n10">
                    <form action="" method="post" autocomplete="off">
                        <div class="card mb-4">
                            <div class="card-header">Edit Data Kustomer Kredit</div>
                            <div class="col">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                        <label class="small mb-1" for="noktp">Nomer KTP</label>
                                        <input class="form-control" id="noktp" name="noktp" type="number" placeholder="Masukkan Nomer KTP" value="<?= $data['no_ktp'] ?>" />
                                        <?= form_error('noktp', '<small class="text-danger pl-2">', '</small>'); ?>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                        <label class="small mb-1" for="nama">Nama Kustomer Kredit</label>
                                        <input class="form-control" id="nama" name="nama" type="text" placeholder="Masukkan Nama Kustomer Kredit" value="<?= $data['nama_penghutang'] ?>" />
                                        <?= form_error('nama', '<small class="text-danger pl-2">', '</small>'); ?>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                        <label class="small mb-1" for="limit">Limit Kredit</label>
                                        <input class="form-control" id="limit" name="limit" type="number" placeholder="Limit Kredit" value="<?= $data['limit_hutang'] ?>" />
