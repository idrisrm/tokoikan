                        ...
                        <div class="page-header-content pt-4">
                            <div class="row align-items-center justify-content-between">
                                <div class="col-auto mt-4">
                                    ...
                                    <div class="page-header-subtitle">Kategori Pengaduan Tertinggi</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container mt-n10">
                    <div class="row">
                        <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-12 col-xs-12 mb-4">
                            <div class="card card-header-actions mx-auto">
                                <div class="card-header">
                                    Grafik 10 Besar Kategori Pengaduan Tertinggi
                                </div>
                        ...
                        <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-12 col-xs-12 mb-4">
                            <div class="card card-header-actions mx-auto">
                                ...
                                <div class="col-12">
                                    <div class="datatable table-responsive mt-3">
                    ...
                    <div class="row">
                        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 mb-4">
                            <div class="card card-header-actions mx-auto">
                                <div class="card-header">
                                    Daftar Kategori Pengaduan Tertinggi
                                </div>
                                <div class="card-body">
                                    <div class="datatable table-responsive">
                                        <table class="table table-striped table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                <?php $no = 1;
                                                foreach ($getTotalKategori as $g) { ?>
                                                    <tr>
                                                        <td><?= $no++ ?></td>
                                                        <td><?= $g->NAME ?></td>
                                                        <td><?= $g->count?></td>
                                                        <td><?= number_format($g->count !== 0 ? ($g->count * 100) / $totalnya : 0) ?> % </td>
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
                                        </table>
    ...
    <script>
        ...
        $(function() {
            ...
            $("#filter_tgl_kategori").daterangepicker({
                ...
                cb
                window.location = window.base_url + 'Dashboard/filtering_kategori?tgl_mulai=' + start.format('YYYY-MM-DD') + '&' + 'tgl_selesai=' + end.format('YYYY-MM-DD');
            });
            // cb(start, end);
