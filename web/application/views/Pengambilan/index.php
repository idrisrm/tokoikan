            ...
            <main>
                            ...
                            <div class="row align-items-center justify-content-between pt-3">
                                <div class="col-auto mb-3">
                                    <h1 class="page-header-title">
                                        ...
                                        Data Pengambilan Pelanggan Cash
                                    </h1>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container mt-4">
                    <nav class="nav nav-borders">
                        <a class="nav-link active" href="<?= base_url('PengambilanPelanggan/index') ?>">Data Pengambilan Pelanggan Cash</a>
                        <a class="nav-link " href="<?= base_url('PengambilanPelanggan/kredit') ?>">Data Pengambilan Pelanggan Kredit</a>
                    </nav>

                    <hr class="mt-0 mb-4" />
                    <div class="card card-header-actions mx-auto mb-4">
                        <div class="card-header">Data Pengambilan Pelanggan Cash<div class="no-caret">
