                ...
                <div class="container-fluid mt-n10">
                    <div class="card card-header-actions mx-auto mb-4">
                        ...
                        <div class="card-header">
                            ...
                            <div class="no-caret">
                                <a class="btn btn-sm btn-primary print_kategori" href="<?= base_url(); ?>export/getPengaduan/proses/">
                                    ...
                                    <tbody id="target">
                                        <!-- <?php
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $d['nm_kategori'] ?></td>
                                                <td>
                                                    <div class="badge badge-warning badge-pill"><?= $d['status'] ?></div>
                                                </td>
                                                <td>
...
<script>
    $(document).ready(function() {
        $("#kategori").select2({
            ...
            idKey = $("#kategori").val();
            console.log(idKey);
            $('.print_kategori').attr('href', '<?= base_url(); ?>export/getPengaduan/proses/' + idKey);
            getFilter(idKey);
        });
    });
    $.ajax({
        url: "<?php echo base_url() . "Pengaduan/data_proses_ajax" ?>",
        dataType: "json",
        success: function(data) {
            ...
            for (var i = 0; i < data.length; i++) {
                baris += '<tr>' +
                    ...
                    '<td>' + '<div class="badge badge-warning badge-pill">Disposisi</div>' + '</td>' +
    ...
    function getFilter(idKey) {
        $.ajax({
            url: "<?= base_url(); ?>Pengaduan/getFilterProses",
            method: "POST",
            data: {
                id_kategori: idKey
            },
