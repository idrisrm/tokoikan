                    ...
                    <form action="" method="post" autocomplete="off">
                        <?php foreach ($dataku as $dataku) { ?>
                            <nav class="nav nav-borders">
                                <a class="nav-link" href="<?= base_url('Pengaduan/detail_arsip/' . $dataku['id_arsip']) ?>">Detail Pengaduan</a>
                                <a class="nav-link active" href="<?= base_url('Pengaduan/komentar_arsip/' . $dataku['id_pengaduan']) ?>">Komentar</a>
                                <a class="nav-link" href="<?= base_url('Pengaduan/tindak_lanjut_arsip/'. $dataku['id_pengaduan']) ?>">Tindak Lanjut</a>
                            </nav>
