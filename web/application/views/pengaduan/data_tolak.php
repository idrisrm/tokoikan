                    ...
                    <div class="container-fluid">
                        <div class="page-header-content">
                            <h1 class="page-header-title">
                                ...
                                <span>Data Tolak Pengaduan</span>
                            </h1>
                ...
                <div class="container-fluid mt-n10">
                    <div class="card card-header-actions mx-auto mb-4">
                        ...
                        <div class="card-header">
                            ...
                            <div class="no-caret">
                                <a class="btn btn-sm btn-primary print_kategori" target="_blank" href="<?= base_url(); ?>export/getPengaduan/tolak">
...
<script>
    $(document).ready(function() {
        ...
        $("#kategori").select2({
            ...
            idKey = $("#kategori").val();
            console.log(idKey);
            $('.print_kategori').attr('href', '<?= base_url(); ?>export/getPengaduan/tolak/' + idKey);
            getFilter(idKey);
        });
    });
    $.ajax({
        url: "<?php echo base_url() . "Pengaduan/data_tolak_ajax" ?>",
        dataType: "json",
        success: function(data) {
            ...
            for (var i = 0; i < data.length; i++) {
                baris += '<tr>' +
                    ...
                    '<td>' + '<div class="badge badge-danger badge-pill">Tolak</div>' + '</td>' +
                    '<td> <a href="detail_tolak/' + data[i].id_pengaduan + '" class="btn btn-datatable btn-icon btn-transparent-dark"><i class="fa fa-search-plus"></i></a></td>'
                '</tr>'
            }
    ...
    function getFilter(idKey) {
        $.ajax({
            url: "<?= base_url(); ?>Pengaduan/getFilterTolak",
            method: "POST",
            data: {
                id_kategori: idKey
            },
