                ...
                <div class="container mt-4">
                    <nav class="nav nav-borders">
                        <?php foreach ($dataku as $d) { ?>
                            <a class="nav-link" href="<?= base_url('Pengaduan/detail_arsip/' . $d['id_arsip']) ?>">Detail Pengaduan</a>
                            <a class="nav-link" href="<?= base_url('Pengaduan/komentar_arsip/' . $d['id_pengaduan']) ?>">Komentar</a>
                            <a class="nav-link active" href="<?= base_url('Pengaduan/tindak_lanjut_arsip/' . $d['id_pengaduan']) ?>">Tindak Lanjut</a>
                        <?php } ?>
                    </nav>
                    <hr class="mt-0 mb-4" />
