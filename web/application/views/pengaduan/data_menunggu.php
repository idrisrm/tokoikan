                    ...
                    <div class="container-fluid">
                        <div class="page-header-content">
                            <h1 class="page-header-title">
                                ...
                                <span>Data Menunggu Pengaduan</span>
                            </h1>
                ...
                <div class="container-fluid mt-n10">
                    <div class="card card-header-actions mx-auto mb-4">
                        ...
                        <div class="card-header">
                            ...
                            <div class="no-caret">
                                <a class="btn btn-sm btn-primary print_kategori" target="_blank" href="<?= base_url(); ?>export/getPengaduan/menunggu">
                                    ...
                                    <tbody id="target">
                                        <!-- <?php
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $d['nm_kategori'] ?></td>
                                                <td>
                                                    <div class="badge badge-danger badge-pill"><?= $d['status'] ?></div>
                                                </td>
                                                <td>
...
<script>
    ...
    $.ajax({
        url: "<?php echo base_url() . "Pengaduan/data_menunggu_ajax" ?>",
        dataType: "json",
        success: function(data) {
            ...
            for (var i = 0; i < data.length; i++) {
                baris += '<tr>' +
                    ...
                    '<td>' + '<div class="badge badge-danger badge-pill">menunggu</div>' + '</td>' +
    ...
    function getData() {
        $.ajax({
            ...
            dataType: "json",
            success: function(data) {
                var html = '<option value="0">' + " Pilih Kategori " + '</option>';
                var no = 1;
                for (var i = 0; i < data.length; i++) {
    ...
    function getFilter(idKey) {
        $.ajax({
            url: "<?= base_url(); ?>Pengaduan/getFilter",
            method: "POST",
            data: {
                id_kategori: idKey
            },
