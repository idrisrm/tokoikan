                    ...
                    <?php foreach ($data as $d) { ?>
                        <?php if ($d['status'] == 'menunggu') { ?>
                            <nav class="nav nav-borders">
                                <a class="nav-link active" href="<?= base_url('Pengaduan/detail/' . $d['id_pengaduan']) ?>">Detail Pengaduan</a>
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="sbp-preview-content">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3 col-sm-12">
                                                    ...
                                                    <?php } else { ?>
                                                        <b class="text-danger">Data Real</b>
                                                    <?php } ?>
                                                </div>
                                            </div>
                                            <div class="row">
                                    ...
                                    <?php if ($d['st_pengaduan'] == 'online') { ?>
                                        <?php if ($d['status'] == 'menunggu') { ?>
                                            ...
                                            <button class="btn btn-success mr-2" type="submit" name="real" id="real">
                                                <span class="text">Filter Real</span>
                                            </button>
