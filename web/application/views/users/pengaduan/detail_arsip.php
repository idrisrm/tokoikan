                ...
                <div class="container mt-4">
                    <?php foreach($data as $d){?>
                        <nav class="nav nav-borders">
                            <a class="nav-link active ml-0" href="<?= base_url('PengaduanOPD/detail_arsip/' . $d['id_arsip']) ?>"">Detail Pengaduan</a>
                            <a class="nav-link" href="<?= base_url('PengaduanOPD/tindak_lanjut_arsip/' . $d['id_pengaduan']) ?>">Tindak Lanjut</a>
                        </nav>
                        <hr class="mt-0 mb-4" />
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="sbp-preview mt-4 mb-4">
                                        <div class="card-header">
                                            ...
                                            <!-- <div class="no-caret">
                                                <a class="btn btn-sm btn-primary" href="<?= base_url('Pengaduan/map/' . $d['id_pengaduan']) ?>">
                                                    Lihat Maps
                                                </a>
                                            </div> -->
                                        </div>
