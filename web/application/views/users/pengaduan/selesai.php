                ...
                <div class="container-fluid mt-n10">
                    <div class="card card-header-actions mx-auto mb-4">
                        ...
                        <div class="card-header">
                            ...
                            <div class="no-caret">
                                <a class="btn btn-sm btn-primary print_kategori" target="_blank" href="<?= base_url(); ?>export/getPengaduanOPD/selesai/">
...
<script>
    $(document).ready(function() {
        ...
        $("#kategori").select2({
            ...
            idKey = $("#kategori").val();
            console.log(idKey);
            $('.print_kategori').attr('href', '<?= base_url(); ?>export/getPengaduanOPD/selesai/' + idKey);
            getFilter(idKey);
        });
    });
    $.ajax({

        url: "<?php echo base_url() . "PengaduanOPD/data_selesai_ajax" ?>",
        dataType: "json",
    ...
    function getFilter(idKey) {
        $.ajax({
            url: "<?= base_url(); ?>Pengaduan/getFilterSelesaiOPD",
            method: "POST",
            data: {
                id_kategori: idKey
            },
