                    ...
                    <div class="container-fluid">
                        <div class="page-header-content">
                            <h1 class="page-header-title">
                                ...
                                <span>Data Tindak Lanjut Pengaduan</span>
                            </h1>
                ...
                <div class="container-fluid mt-n10">
                    <div class="card card-header-actions mx-auto mb-4">
                        ...
                        <div class="card-header">
                            ...
                            <div class="no-caret">
                            <a class="btn btn-sm btn-primary" target="_blank" href="<?= base_url(); ?>export/getPengaduanOPD/selesai/">
...
<script>
    $(document).ready(function() {
        ...
        $("#kategori").select2({
            ...
            idKey = $("#kategori").val();
            console.log(idKey);
            $('.print_kategori').attr('href', '<?= base_url(); ?>export/getPengaduanOPD/konfirmasi/'+idKey);
            getFilter(idKey);
        });
    });
    $.ajax({
        url: "<?php echo base_url() . "PengaduanOPD/data_tindak_ajax" ?>",
        dataType: "json",
    ...
    function getFilter(idKey) {
        $.ajax({
            url: "<?= base_url(); ?>Pengaduan/getFilterTindakOPD",
            method: "POST",
            data: {
                id_kategori: idKey
            },
