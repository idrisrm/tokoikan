            ...
            <main>
                            ...
                            <div class="row align-items-center justify-content-between pt-3">
                                <div class="col-auto mb-3">
                                    <h1 class="page-header-title">
                                        ...
                                        Data Penjualan Wilayah Situbondo
                                    </h1>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container mt-4">
                    <nav class="nav nav-borders">
                        <a class="nav-link " href="<?= base_url('DataPenjualan/jember') ?>">Data Penjualan Wilayah Jember</a>
                        <a class="nav-link active" href="<?= base_url('DataPenjualan/situbondo') ?>">Data Penjualan Wilayah Situbondo</a>
                    ...
                    <div class="card card-header-actions mx-auto mb-4">
                        <div class="card-header">Data Penjualan Wilayah Situbondo<a class="btn btn-sm btn-primary" href="onclick=" confirm_modal() data-toggle="modal" data-target="#modalExport">
