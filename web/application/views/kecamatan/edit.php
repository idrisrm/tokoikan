        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                <div class="container-fluid mt-n10">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">Edit Data Kecamatan</div>
                        <?php foreach($data as $d){?>
                            ...
                            <div class="row">
                                <div class="form-group col-xxl-12 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <input class="form-control" id="nama_kecamatan" name="nama_kecamatan" type="text" placeholder="Masukkan Nama Kecamatan" value="<?= $d['nm_area']?>"/>
                                </div>
                            </div>
